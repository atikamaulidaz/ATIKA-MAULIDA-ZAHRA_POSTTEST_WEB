    ...
    <div class="header">
        ...
        <div class="list-header">
            <ul>
                ...
                <li ><a href="http://localhost/Posttest4/Posttest4.html" style="text-decoration: none;">Home</a></li>
                <li><a href="aboutme.php" style="text-decoration: none;">About Me</a></li>
                <li><a href="index.php" style="text-decoration: none;">Login/Daftar</a></li>
            </ul>  
        </div>
    </div>
    <div class="loginBox">
